### **NOTE:** The problem statement for this project is defined below. All of the parts are accessible from one PDF file in this repository which is **`LendingClub_Loan_Project.pdf`**.
...
* For the purposes of this project, LendingClub is to be interpreted as a traditional lending institution (like a bank), rather than as a peer-to-peer lending platform (as it is in the real world).
* Any conclusions drawn after analyzing this subset may not reflect the real world scenario due to the aforementioned assumptions.
